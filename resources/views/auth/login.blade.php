    ...
    <div class="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="text-slate-500 dark:text-zink-200">Iniciar sesión para continuar con código de estrellas.</p>
            </div>
            ...
            <form action="{{ route('login') }}" class="mt-10" id="" method="POST">
                ...
                <div class="hidden px-4 py-3 mb-3 text-sm text-green-500 border border-green-200 rounded-md bg-green-50 dark:bg-green-400/20 dark:border-green-500/50" id="successAlert">
                    You have <b>successfully</b> registrado.
                </div>
                <div class="mb-3">
                    ...
                    <div id="username-error" class="hidden mt-1 text-sm text-red-500">Por favor, introduce una dirección de correo electrónico válida.</div>
                </div>
                <div class="mb-3">
                ...
                <div>
                    ...
                    <div id="remember-error" class="hidden mt-1 text-sm text-red-500">Por favor, checa el "Remember me" Antes de enviar el formulario.</div>
                </div>
                <div class="mt-10">
                ...
                <div class="mt-10 text-center">
                    <p class="mb-0 text-slate-500 dark:text-zink-200">No tengo una cuenta ?
                        <a href="{{ route('register') }}" class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"> Inscribirse</a>
                    </p>
                </div>
            </form>
        </div>
