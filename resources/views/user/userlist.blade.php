                                ...
                                <tr class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    ...
                                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div class="grow">
                                                <h6 class="mb-1"><a href="#!" class="name">{{ $users->name }}</a></h6>
                                                <p class="text-slate-500 dark:text-zink-200">{{ $users->position }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{ $users->email }}</td>
                                    <td>{{ $users->phone_number }}</td>
                                    <td>{{ \Carbon\Carbon::parse($users->join_date)->diffForHumans() }}</td>                                    
