            ...
            <div class="grid grid-cols-1 2xl:grid-cols-12 gap-x-5">
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            <div
                                class="flex items-center justify-center bg-orange-100 rounded-md size-12 dark:bg-orange-500/20 ltr:float-right rtl:float-left">
                                <i data-lucide="credit-card"
                                    class="text-orange-500 fill-orange-200 dark:fill-orange-500/30"></i>
                            </div>
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            <div
                                class="flex items-center justify-center rounded-md size-12 ltr:float-right rtl:float-left bg-sky-100 dark:bg-sky-500/20">
                                <i data-lucide="circle-dollar-sign"
                                    class="text-sky-500 fill-sky-200 dark:fill-sky-500/30"></i>
                            </div>
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            <div
                                class="bg-yellow-100 rounded-md size-12 ltr:float-right rtl:float-left dark:bg-yellow-500/20">
                                ...
                                <table class="w-full">
                                    <tbody>
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::to('assets/images/img-08.png') }}" alt=""
                                                            class="h-8">
                                                    </div>
                                                    <div class="grow">
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="flex items-center justify-center rounded-md size-12 bg-slate-100 shrink-0">
                                                        <img src="{{ URL::to('assets/images/img-012.png') }}"
                                                            alt="" class="h-8">
                                                    </div>
                                                    <div class="grow">
                                                        <h6 class="mb-1 text-15"><a
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-3.5 py-3 first:pl-0 last:pr-0 ltr:text-right rtl:text-left">$0
                                            </td>
                                        </tr>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div class="shrink-0">
                                    <a href="#!"
                                        class="inline-block text-red-500 underline ltr:mr-2 rtl:ml-2">Cancelled
                                        Order</a>
                                    <a href="apps-invoice-overview.html"
                                        class="py-1 text-xs text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                            ...
                                            class="inline-block align-middle size-4 ltr:mr-1 rtl:ml-1"></i> <span
                                ...
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            ...
                                            <p class="text-gray-400 dark:text-zink-200">Your order has been successfully
                                                submitted.</p>
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            ...
                                            <p class="text-gray-400 dark:text-zink-200">Once the order is received, it goes
                                                through the processing stage. During this time, the items are gathered, and
                                                the order is prepared for shipment.</p>
                                        </div>
                                        <p class="text-sm text-gray-400 dark:text-zink-200 shrink-0">02 Nov, 2023</p>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            ...
                                            <p class="text-gray-400 dark:text-zink-200">The order is shipped out to the
                                                customer's designated delivery address.</p>
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            ...
                                            <p class="text-gray-400 dark:text-zink-200">This status indicates that the
                                                order
                                                is currently out for delivery by the shipping or courier company.</p>
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            ...
                                            <p class="text-gray-400 dark:text-zink-200">Finally, when the order
                                                successfully
                ...
                <div class="2xl:col-span-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="px-3.5 first:pl-0 last:pr-0 py-2 border-y border-transparent"><a
                                                    href="apps-invoice-overview.html"
                                                    class="text-custom-500">#TWI154203</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-3.5 first:pl-0 last:pr-0 py-2 border-y border-transparent">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="flex gap-4">
                                <div class="shrink-0">
                                    <img src="{{ URL::to('assets/images/delivery-1.png') }}" alt=""
                                        class="h-10">
                                </div>
                                <div class="grow">
