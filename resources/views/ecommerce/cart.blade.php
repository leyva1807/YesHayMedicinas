...
@section('content')
    ...
    <div
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-x-5">
                <div class="xl:col-span-9 products-list">
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <div>
                            <a href="#!"
                                class="text-red-500 transition-all duration-300 ease-linear hover:text-red-600"><i
                                    data-lucide="trash-2" class="inline-block mr-1 align-middle size-4"></i> <span
                            ...
                            <div class="card-body">
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                                    ...
                                    <div class="flex flex-col lg:col-span-4">
                                        <div>
                                            <h5 class="mb-1 text-16"><a href="apps-ecommerce-product-overview.html">Roar
                                                    Twill Blue Baseball Cap</a></h5>
                                            <p class="mb-2 text-slate-500 dark:text-zink-200"><a href="#!">Men's
                                                    Fashion</a></p>
                        ...
                        <div class="card products" id="product2">
                            <div class="card-body">
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                                    ...
                                    <div class="flex flex-col lg:col-span-4">
                                        <div>
                                            <h5 class="mb-1 text-16"><a href="apps-ecommerce-product-overview.html">Mesh
                                                    Ergonomic Green Chair</a></h5>
                                            <p class="mb-2 text-slate-500 dark:text-zink-200"><a href="#!">Home,
                                                    Kitchen, Pets</a></p>
                                            <p class="mb-1 text-slate-500 dark:text-zink-200">Color: <span
                        ...
                        <div class="card products" id="product3">
                            <div class="card-body">
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                                    ...
                                    <div class="flex flex-col lg:col-span-4">
                                        <div>
                                            <h5 class="mb-1 text-16"><a
                                                    href="apps-ecommerce-product-overview.html">Smartest Printed
                                                    T-shirt</a></h5>
                                            <p class="mb-2 text-slate-500 dark:text-zink-200"><a href="#!">Unisex
                                                    Fashion</a></p>
                                            <p class="mb-1 text-slate-500 dark:text-zink-200">Color: <span
        ...
        <!-- End Page-content -->
    @section('script')
        <script src="{{ URL::to('assets/js/pages/apps-ecommerce-cart.init.js') }}"></script>
    @endsection
@endsection
