...
')
     ...
     */        class URL {
        ...
        {
                        /** @var \LaravelLang\Routes\Services\UrlGenerator $instance */
         ...
         *
         * @param \Closure $callback
         * @return \LaravelLang\Routes\Services\UrlGenerator 
         * @static 
         ...
         */        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        \LaravelLang\Routes\Services\UrlGenerator::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
         ...
         */        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        \LaravelLang\Routes\Services\UrlGenerator::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
         ...
         */        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        return \LaravelLang\Routes\Services\UrlGenerator::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
         ...
         */        public static function flushMacros()
        {            //Method inherited from \Illuminate\Routing\UrlGenerator         
                        \LaravelLang\Routes\Services\UrlGenerator::flushMacros();
        }
            }
            /**
     * 
